...
fun DetailsScreen(
    ...
    val movie by movieRepository.getMovieById(movieId).collectAsState(initial = null)
    if (movie == null) {
        Scaffold(topBar = {
            TopAppBar(title = { Text("Loading...") }, navigationIcon = {
        ...
        Column(modifier = Modifier
            ...
            LazyRow(
                ...
                items(movie!!.actors) { actor ->
                    ...
                    ActorItem(name = actor.name, photoUrl = actor.profileUrl)
                }
            }
